...
Future<dynamic> fetchTranslation(String username) async {
  final response = await http.get('$apiAuthorityUrl/users/$username/translations');
...
Future<int> uploadTranslationFile(int translationId, String filePath) async{
  http.MultipartRequest request = http.MultipartRequest(
      'post',
      Uri.parse("$url/$translationId/upload-audio"));
